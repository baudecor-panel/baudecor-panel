...
export default function ProductsPage() {
  ...
  type ExportRow = {
    ...
    "Proizvod": string;
    "Dobavljač": string;
    "Početna zaliha": number | string;
    "Zabilježena zaliha": number | string;
    "Izračunata zaliha": number | string;
    "Minimalna zaliha": number | string;
    "Razlika": number | string;
    "Status": string;
    "Prodajna cijena (€)": number | string;
    "Trošak (€)": number | string;
    "Marža (€)": number | string;
    "Trošak zalihe (€)": number | string;
    "Prodajna vrijednost (€)": number | string;
    "Potencijalna dobit (€)": number | string;
    "Broj kretanja": number | string;
    "Saldo kretanja": number | string;
    "Zadnje kretanje": string;
    "Aktivnost": string;
  };

  function exportFilteredStock() {
    const rows: ExportRow[] = filteredProducts.map((p) => {
